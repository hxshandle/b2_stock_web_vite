...
.card
  .card-body
    ...
    .row
      .clo
        .btn-group
          button.btn.btn-primary.btn-sm(@click='switchCandlePartten("star_hammer")' :class='{active: mainStore.candlePattern == "star_hammer"}') 锤子
          button.btn.btn-primary.btn-sm(@click='switchCandlePartten("engulf")' :class='{active: mainStore.candlePattern == "engulf"}') 吞没
